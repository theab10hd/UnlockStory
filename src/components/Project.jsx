...
const Project = ({ title, description, image, link, client }) => {
  return (
    <div className="flex flex-col p-3 gap-4 md:gap-4 lg:flex-row bg-gradient-to-b to-[var(--dark)] from-[var(--dark-light)] z-10 justify-between border-1 border-gray-800/50 w-full h-full rounded-xl hover:shadow-xl hover:scale-101 transition-all duration-300">
